...
const ImportExcelButton: React.FC<Props> = ({ onAddItem }) => {
  ...
  return (
    <div className="ieb-footer">
      {/* Panel expandible */}
      {expanded && (
        <div className="ieb-panel">
          <div className="ieb-panel-inner">
            <p className="ieb-desc">
              Sube un archivo <strong>.xlsx</strong> con las columnas:
              <em> Área, Solicitante, Elemento, Categoría, Prioridad, Cantidad, Justificación</em>.
              Los ítems se agregarán a la tabla actual.
            </p>

            <div className="ieb-actions">
              <button className="ieb-btn-import" onClick={() => fileRef.current?.click()} disabled={importing}>
                {importing ? (
              ...
              <button className="ieb-btn-sample" onClick={downloadSample}>
            ...
            <div className="ieb-example-preview">
              ...
              <div className="ieb-ex-scroll">
                <table className="ieb-ex-table">
                  ...
                  <tbody>
                    <tr>
                      <td>Contabilidad</td><td>María López</td><td>Mouse</td>
                      <td>Puesto de trabajo</td><td>Alta</td><td>1</td><td>Reposición por daño</td>
                    </tr>
                    <tr>
                      <td>TI</td><td>Ana Torres</td><td>PC / Laptop</td>
                      <td>Equipo de cómputo</td><td>Alta</td><td>1</td><td>Equipo obsoleto</td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      {/* Barra toggle — mismo estilo que RevisionesPanel */}
      <div
        className="ieb-bar"
      ...
      >
        <div className="ieb-bar-left">
          ...
          <span className="ieb-bar-title">Importar Excel</span>
        </div>
        <svg
          className={`ieb-chevron${expanded ? ' ieb-chevron-up' : ''}`}
